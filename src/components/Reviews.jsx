      ...
      <div className="max-w-full mx-auto text-center shadow-md p-4 my-4 bg-white rounded-sm">
        ...
        <Slider {...settings}>
          {ReviewsData.map((item, index) => (
            <div
              key={index}
              className="flex min-w-[400px] p-3 min-h-[140px] max-w-[400px] mx-auto py-5 flex-col justify-center items-center service shadow-xl my-4 bg-white border rounded-md hover_cards transition-all ease-in-out duration-300 cursor-pointer"
            >
              <div className="flex flex-col justify-center mx-10">
                <div className="flex">
                  <img className="w-[36px] h-[36px]" src={item.image} alt="image" />
