  ...
  return (
    <div className="bg-[#FFEAAA]  rounded-md shadow-[0px_0px_1px_rgba(0,0,0,0.12),0px_1px_0px_rgba(0,0,0,0.12)] px-4 py-7">
      <div className="flex flex-col justify-center items-center">
        ...
        <input
          className="bg-white max-w-[600px] mx-auto min-w-[270px] sm:min-w-[600px] mt-3 text-[#130F26] rounded-[21px] shadow-[0px_1px_1px_#ffca28] border outline-none border-[#FFCA28] px-4 py-2"
          type="text"
