      ...
      <div className="mx-2 my-8 border-b pb-8 border-gray-400">
        <div className="w-full flex flex-wrap    ">
          <div className="w-full sm:w-1/2 xl:w-1/3 lg:border-r-2 px-4">
            <h2 className="font-bold lg:text-xl mt-5 lg:mt-0 ">CONTACT INFO</h2>
            <ul className="ps-0 mt-4 flex flex-col gap-3">
              <li className=" cursor-pointer text-xs  md:text-md text-gray-600">
              ...
              <li className="flex ">
                <button className="border border-[#ed1c24] text-[#ed1c24] md:text-md  rounded-[3px] px-2 py-[6px] mt-4 lg:mt-7">
                  Get Directions
                </button>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-1/2 xl:w-1/3 px-4">
            <div className="w-full flex ">
              <div className="w-1/2 lg:border-r-2 ">
                <h2 className="font-bold text-sm lg:text-xl mt-5 lg:mt-0 ">PRODUCTS</h2>
                <ul className="ps-0 mt-4 flex flex-col gap-3 ">
                  <li className=" cursor-pointer hover:text-[#ed1c24] transition-all ease-out duration-300 text-xs md:text-md text-gray-600">
                    Prices Drop
                  </li>
                  <li className=" cursor-pointer hover:text-[#ed1c24] transition-all ease-out duration-300 text-xs md:text-md text-gray-600">
                    New Products
              ...
              <div className="w-1/2 lg:border-r-2 px-4 ">
                <h2 className="font-bold text-sm lg:text-xl mt-5 lg:mt-0 ">OUR COMPANY</h2>
                <ul className="ps-0 mt-4 flex flex-col gap-3  ">
                  <li className=" cursor-pointer hover:text-[#ed1c24] transition-all ease-out duration-300 text-xs md:text-md text-gray-600">
                    Delivery
                  </li>
          ...
          <div className="w-full sm:w-1/2 xl:w-1/3  px-4">
            <h2 className="font-bold lg:text-xl mt-7 xl:mt-0">NEWSLETTER </h2>
            <ul className="ps-0 mt-4 flex flex-col gap-3 ">
              <li className="text-xs md:text-md text-gray-600">
              ...
              <li className="bg-white max-w-[300px] min-w-[270px] sm:min-w-[400px] flex items-center justify-between mt-3 text-[#130F26] rounded-[10px] shadow-[0px_1px_1px_#ffca28] border border-[#FFCA28] px-4 py-2">
                <input
                  className="w-full outline-none text-xs md:text-md"
                  type="text"
